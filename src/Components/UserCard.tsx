...
const UserCard = ({user, handleClick, isSelected}: UserCardProps) => {
    ...
    return (
        <div 
        className="w-full h-56 bg-slate-300 hover:bg-indigo-50 p-5 pt-6 hover:cursor-pointer rounded-md"
        ...
        style={{backgroundColor: isSelected ? '#eef2ff' : ''}}>
            <div className="space-y-2">
                ...
                <div className="">
                    ...
                    <p className="text-sm text-center text-gray-500">@{user.username}</p>
                </div>
            </div>
        </div>
    )
