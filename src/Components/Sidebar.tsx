...
const Sidebar = () => {
  return (
    ...
    <aside className="w-64 max-h-screen" aria-label="Sidebar" >
      <div className="w-60 fixed left-0 top-0 h-screen bg-slate-700 overflow-y-auto py-12 px-8 bg-gray-50 dark:bg-gray-800 min-h-screen">
        ...
        <ul className="space-y-2">
          <li>
            <a href="/users" className="flex items-center justify-center space-x-4 px-4 py-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
