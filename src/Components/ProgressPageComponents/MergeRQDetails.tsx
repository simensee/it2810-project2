            ...
            {(merge.title !== 'empty') ?
                <div className='col-span-1 w-full flex flex-col gap-2 p-4 bg-stone-100 rounded-md'>
                    ...
                    <div className='w-full flex flex-col lg:grid lg:grid-cols-3 lg:gap-1'>
                        <span className='w-full lg:col-span-1'>Merged: </span>
                        <span className='w-full lg:col-span-2 text-black/40'>{merge.merged_at?.split('T')[0]}</span>
                    </div>
                    <div className='w-full flex flex-col lg:grid lg:grid-cols-3 lg:gap-1'>
                        <span className='lg:col-span-1'>Target:</span>
                        <span className='lg:col-span-2'>{merge.target_branch}</span>
                    </div>
                    <div className='w-full flex flex-col lg:grid lg:grid-cols-3 lg:gap-1'>
                        <span className='w-full lg:col-span-1'>Author: </span>
                        <span className='w-full lg:col-span-2'>{merge.author?.name}</span>
                    </div>
                    <div className='w-full flex flex-col lg:grid lg:grid-cols-3 lg:gap-1'>
                        <span className='w-full lg:col-span-1'>Decription: </span>
                    ...
                    <div className='w-full flex flex-col lg:grid lg:grid-cols-3 lg:gap-1'>
                        <span className='lg:col-span-1'>Assignees:</span>
